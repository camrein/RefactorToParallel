...
namespace RefactorToParallel.Evaluation.ByFor {
  ...
  public class Program {
    ...
    private static readonly Type[] _analysisTypes = { typeof(ForAnalyzer), typeof(ParallelizableForAnalyzer) };
    ...
    static void Main(string[] args) {
      ...
      Console.WriteLine("scanning for parallelizable for loops");
